    ...
    <PageBase  title="Edit Store" >
      <form  styles={styles.form} >
        ...
        <br></br>
            ...
            <TextField name="delivery_time"  label="Delivery Time" type="string"></TextField>
            <br></br>
            <br></br>
         ...
         <h2 style={styles.toggledi}><b> Delivery Description</b></h2>
             <SunEditor autoFocus={true} type="string" setDefaultStyle="font-family: cursive; font-size: 15px;" placeholder="Add Discription Here..."
             enableToolbar={true} setOptions={{
             height: 120
             }} />
            <br></br>
